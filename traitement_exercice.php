...
<body>
  <div class="container">
    <h1>les données d'exercice sont sauvegardées avec succès !</h1>
    <p>Merci pour votre contribution.</p>
    <p class="success-message">Vos données ont été enregistrées de manière sécurisée dans la base de données.</p>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $nomExercice = $_POST['nom_exercice'];
    ...
    if (isset($_FILES['fichier']) && $_FILES['fichier']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "INSERT INTO exercice (nom_exercice, annee_scolaire, branche, fichier) VALUES ('$nomExercice', '$anneeScolaire', '$branche', '$destination')";
